...
class RoverState():
    def __init__(self):
        ...
        #                                         xlabel='total_time',
        #                                         ylabel='Percentage'))
        # self.v_perc_mapped = self.v.line(np.array([0.0]), X=np.array([0.0]),
        #                               opts=dict(title="Percentage Mapped",
        #                                         xlabel='total_time',
        #                                         ylabel='Percentage'))
        # self.v_samples_located = self.v.line(np.array([0]), X=np.array([0.0]),
